  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-professional': 'linear-gradient(to bottom right, hsl(var(--navy)), hsl(var(--navy-light)), hsl(var(--steel)))',
        'gradient-gold': 'linear-gradient(to right, hsl(var(--gold-dark)), hsl(var(--gold)), hsl(var(--gold-light)))',
      },
    },
  },
  plugins: [],
