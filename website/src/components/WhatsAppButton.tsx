...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 bg-green-500 text-white rounded-full p-4 shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 group"
